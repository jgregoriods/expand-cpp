...
/**
 * Adds the unique id of an agent to the cell it occupies in the
 * the model's grid.
 *
...
/**
 * Adds the unique id of an agent to the cell it owns in the
 * the model's grid.
 *
 * @param agent_id The id of the agent.
 * @param x The x coordinate of the cell.
...
/**
 * Records the current (simulated) date in a grid cell.
 *
 * @param x The x coordinate of the cell.
 * @param y The y coordinate of the cell.
 */
...
/**
 * Returns the number of agents currently in the model.
 *
...
/**
 * Writes the layer with the simulated dates to an asc file.
 */
...
/**
 * Returns whether a given pair of (x, y) coordinates is valid, i.e.
 * if it is in the model's grid.
 *
 * @param x The x coordinate of the cell.
 * @param y The y coordinate of the cell.
 * @return a boolean.
...
/**
 * Returns whether a given cell is suitable for settlement based on
 * the grid's suitability layer.
 *
 * @param x The x coordinate of the cell.
 * @param y The y coordinate of the cell.
 * @return a boolean.
...
/**
 * Converts a pair of (x, y) coordinates in the Albers projection
 * to the model's grid coordinates.
 *
 * @param x The x coordinate of the cell.
 * @param y The y coordinate of the cell.
 * @return a boolean.
...
/**
 * Given a site name, returns the respective coordinates (in Albers projection)
 * based on a file listing names and coordinates.
 *
 * @param site_name The name of the site to be searched.
