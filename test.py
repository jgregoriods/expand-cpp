...
SETTINGS = [("arawak", 4400, "latia", 0.224, 0.0, "arawak_sw"),
            ("arawak", 4400, "latia", 0.224, 0.5, "arawak_sw"),
            ("arawak", 3000, "saladero", 0.224, 0.0, "arawak_short"),
            ("arawak", 3000, "saladero", 0.224, 0.5, "arawak_short"),
            ("tupi", 4100, "encontro", 0.244, 0.0, "tupi_sw"),
            ("tupi", 4100, "encontro", 0.244, 0.5, "tupi_sw"),
